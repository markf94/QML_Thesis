...
Ideally demonstrate quantum advantages over the classical counterparts

Provide supporting evidence for the claim that QML can indeed be used to solve ML problems and that upscaling QT will bring the expected speed-ups in computation
