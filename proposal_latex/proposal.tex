...
\begin{figure}[!ht]
      \centering
       ...
       \caption[caption for qcircuit]{\label{fig:qcircuit} Basic quantum circuit with a single-qubit Hadamard gate (creating a superposition as in Equ.~\ref{equ: simplequbit} with $\alpha=\beta=\frac{1}{\sqrt{2}}$) and a multi-qubit CNOT gate (controlled bit flip)\footnotemark[2]}
\end{figure}
