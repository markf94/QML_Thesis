...
$\begin{pmatrix}
 ...
 \textcolor{blue}{0110} \\ 
 \textcolor{green}{0100}
 \end{pmatrix} \rightarrow n=\textcolor{blue}{0110}\textcolor{green}{0100} \rightarrow \ket{n} = \ket{\textcolor{blue}{0110}\textcolor{green}{0100}}$\\
...
$\begin{pmatrix}
 \textcolor{blue}{0.6} \\ 
 \textcolor{green}{0.4}
 \end{pmatrix} \quad \rightarrow \quad \ket{n} = \sqrt{\textcolor{blue}{0.6}}\ket{0}+\sqrt{\textcolor{green}{0.4}}\ket{1}$\\
%\textbf{Possibility of exponential speed up}
\end{alertblock}
...
Perform \textbf{conditional measurement} on ancilla qubit.\\
