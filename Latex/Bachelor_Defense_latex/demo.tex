...
Enable quantum computers how to learn from data
...
{
\setbeamertemplate{frame footer}{\tiny{\textsuperscript{1}}}
\begin{frame}[fragile]{Supervised pattern recognition}

Introduce the concept of training and input dataset
labels as well as supervision
...
{
\setbeamertemplate{frame footer}{\tiny{\textsuperscript{1}}}
\begin{frame}[fragile]{$k$-nearest neighbour algorithm}
...
{
\setbeamertemplate{frame footer}{\tiny{\textsuperscript{1}}}
\begin{frame}[fragile]{Quantum bits (Qubits)}
...
{
\setbeamertemplate{frame footer}{\tiny{\textsuperscript{1}}}
\begin{frame}[fragile]{Visualizing a qubit}

Bloch sphere intro
maybe not needed if I concentrate on qubit-based kNN only
