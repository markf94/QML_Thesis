...
Since the IBM Quantum Experience does not allow for an implementation, the Bloch vector classification problem described in Section~\ref{subsubsec:implementationamplitudeKNN} was simulated in Liqui$\ket{}$ to determine the performance and the outcome of the algorithm.
